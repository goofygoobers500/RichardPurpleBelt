...
public class GameController : MonoBehaviour
{
   ...
   [Header("Tet object")]
    ...
    void Update()
    {
        ...
        var pos1 = lastCube.transform.position + Vector3.up * 10;
    ...
    void NewBlock()
    {
        ...
        if (lastCube != null)
        {
            ...
            currentCube.transform.localScale = new Vector3(lastCube.transform.localScale.x - Mathf.Abs(currentCube.transform.position.x - lastCube.transform.position.z),
                                                            lastCube.transform.localScale.y,
                                                            lastCube.transform.localScale.z - Mathf.Abs(currentCube.transform.position.z - lastCube.transform.position.z));

            currentCube.transform.position = Vector3.Lerp(currentCube.transform.position, lastCube.transform.position, 0.05f) + Vector3.up * 5f;
